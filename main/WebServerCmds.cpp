	...
	namespace server
	{
									...
									const std::string &extra, const std::string idx = "")
		{
			...
			// Below Hardware Types do not have any input checks at the moment
					...
					|| (htype == HTYPE_OpenWebNetUSB) || (htype == HTYPE_IntergasInComfortLAN2RF) || (htype == HTYPE_EnphaseAPI) || (htype == HTYPE_EcoCompteur) || (htype == HTYPE_Meteorologisk) || (htype == HTYPE_VirtualThermostat)
