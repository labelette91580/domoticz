...
pause                                                          -m " merge                         "
"C:\Program Files\Git\bin\"git merge  scripteHumidity          -m " merge scripteHumidity         "
pause                                                          -m " merge                         "
"C:\Program Files\Git\bin\"git merge  LogFilter                -m " merge LogFilter               "
pause                                                          -m " merge                         "
"C:\Program Files\Git\bin\"git merge  imperihome1              -m " merge imperihome1             "
pause                                                          -m " merge                         "
